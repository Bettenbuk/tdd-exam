...
public class MetroTicketValidatorTest {
    ...
    private final MetroTicketValidator metroTicketValidator = new MetroTicketValidator();
    private LocalDateTime ticketUsingStartTime;
    private String ticket = "0643xxx";

    @Test
    public void ticketIsExpired(){
        ticketUsingStartTime= LocalDateTime.now().minusMinutes(VALIDATION_TIME+1);
        ticket += TimeConverter.convertToMetroTimeFormat(ticketUsingStartTime);
